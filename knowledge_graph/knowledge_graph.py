'''Copied from RUCKBReasoning/SubgraphRetrievalKBQA/knowledge_graph/knowledge_graph.py
...
class KnowledgeGraph(object):
    ...
    def load_from_ckpt(cls, ckpt_path):
        ...
        return KnowledgeGraph(data_dict['G'], data_dict['head2relation'], data_dict['head_relation_2_tail'])
    ...
    def load_from_triples(cls, triples: List[Tuple[str, str, str]]):
        ...
        return KnowledgeGraph(G, head2relation, head_relation_2_tail)
